...
struct HNSW {
    ...
    /// when set to false, avoid SIMD-friendly batched distance paths
    bool use_optimized_search = true;

    /// when set to false, fall back to reference neighbor selection
    bool use_optimized_graph = true;
