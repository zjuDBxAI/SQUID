...
struct FlatL2Dis : FlatCodesDistanceComputer {
    ...
    // Disabled batched L2 distance optimization for profiling; rely on scalar fallback.
...
struct FlatIPDis : FlatCodesDistanceComputer {
    ...
    // Disabled batched IP distance optimization for profiling; rely on scalar fallback.
    /*void distances_batch_4(
            const idx_t idx0,
            const idx_t idx1,
            const idx_t idx2,
