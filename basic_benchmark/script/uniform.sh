...
run_step "Generate random RBAC data"   "${PYTHON_BIN}" services/rbac_generator/store_random_rbac_generate_data.py
...
run_step "Build AnonySys dynamic partition"   "${PYTHON_BIN}" controller/dynamic_partition/hnsw/AnonySys_dynamic_partition.py --storage 3.0 --recall 0.99
